...
<%	
	...
	memberCount = memberDao.getDisableCount();//得到被禁用会员的总数量值
	pageCount = (memberCount+(pageSize-1))/pageSize;//计算页数
	if(request.getParameter("page")!=null){
		currentPage = Integer.parseInt(request.getParameter("page"));
	}
	//根据当前页数和一页显示的数量查询该页要显示的会员集合
	ArrayList<Member> memberList = memberDao.queryDisableByPage(currentPage,pageSize);
...
function goByInput(){
	...
	if(num.value!=""){
		location="DisableMemberEdit.jsp?page="+num.value;
	}
}
//批量启用和禁用的方法
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[用户管理]-[已禁用会员]</td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <input type="button" onclick="batchChangeStatus(true);" value="批量启用" />
            ...
            <td><table border="0" align="right" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="40"><a href="DisableMemberEdit.jsp?page=1" ><img src="tab/images/first.gif" width="37" height="15" /></a></td>
                  <td width="45"><a href="DisableMemberEdit.jsp?page=<%=lastPage %>"><img src="tab/images/back.gif" width="43" height="15" /></a></td>
                  <td width="45"><a href="DisableMemberEdit.jsp?page=<%=nextPage %>"><img src="tab/images/next.gif" width="43" height="15" /></a></td>
                  <td width="40"><a href="DisableMemberEdit.jsp?page=<%=pageCount %>"><img src="tab/images/last.gif" width="37" height="15" /></a></td>
