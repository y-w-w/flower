...
<%	
	...
	memberCount = memberDao.getCount();//得到会员的总数量值
	pageCount = (memberCount+(pageSize-1))/pageSize;//计算页数
	if(request.getParameter("page")!=null){
		currentPage = Integer.parseInt(request.getParameter("page"));
	}
	//根据当前页数和一页显示的数量查询该页要显示的会员集合
	ArrayList<Member> memberList = memberDao.queryByPage(currentPage,pageSize);
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[用户管理]-[会员管理]</td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#0080ff" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">${member.nickName}</span></div></td>
          ...
          <tr>
            ...
            <td><table border="0" align="right" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="40"><a href="MemberEdit.jsp?page=1" ><img src="tab/images/first.gif" width="37" height="15" /></a></td>
                  <td width="45"><a href="MemberEdit.jsp?page=<%=lastPage %>"><img src="tab/images/back.gif" width="43" height="15" /></a></td>
                  <td width="45"><a href="MemberEdit.jsp?page=<%=nextPage %>"><img src="tab/images/next.gif" width="43" height="15" /></a></td>
                  <td width="40"><a href="MemberEdit.jsp?page=<%=pageCount %>"><img src="tab/images/last.gif" width="37" height="15" /></a></td>
