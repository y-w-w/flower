...
<%
	...
	ordersCount = ordersDao.getCount3();//得到会员的总数量值
	String str = null;
	String string = null;
	...
	ArrayList<OrdersStatu> orderList = ordersDao.queryByPageStatus3(currentPage,pageSize);
							...
							<td><table width="100%" border="0" cellspacing="0"
									...
									<tr>
										...
										<td><table border="0" align="right" cellpadding="0"
												...
												<tr>
													<td width="40"><a
														href="ordersManagerstatus3.jsp?page=1"><img
															src="tab/images/first.gif" width="37" height="15" /></a></td>
													<td width="45"><a
														href="ordersManagerstatus3.jsp?page=<%=lastPage%>"><img
															src="tab/images/back.gif" width="43" height="15" /></a></td>
													<td width="45"><a
														href="ordersManagerstatus3.jsp?page=<%=nextPage%>"><img
															src="tab/images/next.gif" width="43" height="15" /></a></td>
													<td width="40"><a
														href="ordersManagerstatus3.jsp?page=<%=pageCount%>"><img
