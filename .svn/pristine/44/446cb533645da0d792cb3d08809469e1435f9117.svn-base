...
<%
	...
	ordersCount = ordersDao.getCount();//得到会员的总数量值
	OrdersStatu order=new OrdersStatu();
	String str = null;
	String string = null;
	...
	ArrayList<OrdersStatu> orderList = ordersDao.queryByPage(currentPage,pageSize);
	for(int t=0 ;t<orderList.size();t++){
		
		if("0".equals(orderList.get(t).getOrdersPaymen())){
		
	string="未付款";
		}
		else if("1".equals(orderList.get(t).getOrdersPaymen())){
	string="已付款";
		}
	  ...
	  for(int t=0 ;t<orderList.size();t++){
		...
		System.out.println(orderList.get(t).getOrdersStatus());
		}
	//获取ordersID
	  for(int t=0 ;t<orderList.size();t++){
									...
									<tr>
										<td width="46%" valign="middle"><table width="100%"
												...
												<tr>
													...
													<td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[订单管理]-[订单管理]</td>
												</tr>
											</table></td>
                ...
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center">新增</div></td>
									...
									<td class="STYLE1"><div align="center" class="mouse" onclick="changeorder()">修改</div></td>
														</tr>
													</table></td>
							...
							<td><table width="100%" border="0" cellspacing="0"
									...
									<tr>
										...
										<td><table border="0" align="right" cellpadding="0"
												cellspacing="0">
												<tr>
													<td width="40"><a href="ordersManager.jsp?page=1"><img
															src="tab/images/first.gif" width="37" height="15" /></a></td>
													<td width="45"><a
														href="ordersManager.jsp?page=<%=lastPage%>"><img
															src="tab/images/back.gif" width="43" height="15" /></a></td>
													<td width="45"><a
														href="ordersManager.jsp?page=<%=nextPage%>"><img
															src="tab/images/next.gif" width="43" height="15" /></a></td>
													<td width="40"><a
														href="ordersManager.jsp?page=<%=pageCount%>"><img
													...
													<td width="40"><a href="javascript:goByInput();">
													<img src="tab/images/go.gif" width="37" height="15" /></a></td>
												</tr>
											</table></td>
									</tr>
								</table></td>
...
function ChangeStatus(){
		...
		$.post("/Flower/admin/AdminChangeOrdersStatesServlet",{memberid:id,status:statu},
			function(rs){
			if(rs>0){
				alert("操作成功");
