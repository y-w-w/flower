...
<%
	...
	ordersCount = ordersDao.getCount4();//得到会员的总数量值
	String str = null;
	String string = null;
	...
	ArrayList<OrdersStatu> orderList = ordersDao.queryByPageStatus4(currentPage,pageSize);
									...
									<tr>
										<td width="46%" valign="middle"><table width="100%"
												...
												<tr>
													...
													<td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[订单管理]-[显示交易成功订单]</td>
												</tr>
											</table></td>
							...
							<td><table width="100%" border="0" cellspacing="0"
									...
									<tr>
										...
										<td><table border="0" align="right" cellpadding="0"
												...
												<tr>
													<td width="40"><a
														href="ordersManagerstatus4.jsp?page=1"><img
															src="tab/images/first.gif" width="37" height="15" /></a></td>
													<td width="45"><a
														href="ordersManagerstatus4.jsp?page=<%=lastPage%>"><img
															src="tab/images/back.gif" width="43" height="15" /></a></td>
													<td width="45"><a
														href="ordersManagerstatus4.jsp?page=<%=nextPage%>"><img
															src="tab/images/next.gif" width="43" height="15" /></a></td>
													<td width="40"><a
														href="ordersManagerstatus4.jsp?page=<%=pageCount%>"><img
