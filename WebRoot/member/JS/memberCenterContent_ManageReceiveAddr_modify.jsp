...
<div class="content">
		...
		<form method="POST" onSubmit="return FormCheck();" action="MemberCenterManageReceiveAddr?type=update" name="form1">
        
          <table width="550" border="1" cellpadding="2" cellspacing="0" bordercolor="#D4D4D4" style="border-collapse:collapse">
            <tr bgcolor="#E6E6E6"> 
              <td colspan="2">请填写收件人地址：</td>
            </tr>
            <tr> 
              <td align="right">姓&nbsp;&nbsp;&nbsp;&nbsp;名：</td>
                <input type="hidden" name="consigneeID" value="${requestScope.consignee2.consigneeId }"> 
