...
function  discuss(ordersId){
	asyncbox.open({
		url : 'ordersComment.jsp',
			data : 'id='+ordersId,
			title:"订单评论",
		width : 800,
		height : 500
  ...
  <div>
        ...
        <c:forEach items="${memberlist}" var="olist" varStatus="status">
          <tr> 
            ...
            <td align="center" ><font size="2" ><a href="#") onclick="discuss(${olist.ordersId});">${olist.ordersStatus}</a></font></td>
